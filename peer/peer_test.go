...
{"choke", &peer.Message{ID: peer.MsgChoke, Payload: nil}},
{"unchoke", &peer.Message{ID: peer.MsgUnchoke}},
{"interested", &peer.Message{ID: peer.MsgInterested}},
{"bitfield", &peer.Message{ID: peer.MsgBitfield, Payload: []byte{0xff, 0x80}}},
{"have", &peer.Message{ID: peer.MsgHave, Payload: []byte{0, 0, 0, 5}}},
}
