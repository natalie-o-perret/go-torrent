...
Left       int64
Event      Event
NumWant    int // number of peers to request; use -1 for the tracker default
}
...
Interval    int    // seconds between regular announces
MinInterval int    // minimum allowed announce interval
TrackerID   string // opaque tracker ID to send in subsequent requests
